...
<p>This way isn’t the most cross-browser (see <a href="https://caniuse.com/#feat=mdn-svg_elements_use_external_uri">support</a>), but it preserves the size of the HTML document. If the symbols are needed for a single article, and there are not too many of them, the contents of the sprite can be included directly inside the &lt;body&gt;. Thus, links to individual icons become shorter: <code>&lt;svg&gt;&lt;use&thinsp;xlink:href=&#173;"#icon-name"/&gt;&lt;/svg&gt;</code>.</p>
