...
<div><h2 id="1">How to save a bookmarklet to Favorites in mobile browsers</h2>
  <p>It’s so easy on a PC; you just drag the link to the bookmarks bar. <span itemscope itemprop="mainEntity" itemtype="https://schema.org/Question"><meta itemprop="name" content="How to add a bookmarklet to the mobile bookmarks?"><span itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"><span itemprop="text">That’s why the easiest way to create a JS bookmark on your phone is to enable synchronization between mobile and desktop browsers in your account. If this is unacceptable to you, there are two ways.</span></span></span></p>
