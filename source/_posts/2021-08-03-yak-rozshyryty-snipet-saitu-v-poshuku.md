...
title: "Як розширити сніпет і підняти CTR сторінки в Google пошуку"
tags: [CTR, Rich Results, сніпет, SERP, SEO]
description: "Потрапивши до результатів Google, сторінка змагається за клік і своє майбутнє. Органічний CTR нижче, ніж у конкурентів => позиції просядуть. Збагачуємо сніпет і підвищуємо CTR!"
...
---
<ul class="toc">
  <li><a href="#1">Мета – розширений фрагмент у Пошуку</a></li>
  <li><a href="#2">SEO оптимізація сніпета</a></li>
  <li><a href="#3">Інструменти для формування сніпета&#160;&#160;<i class="icon icon-wrench red"></i></a></li>
</ul>
<div>
...
<p>Загальні типи сутностей, на зразок Organization, Person, BlogPosting, краще описувати в JSON: для цього існують онлайн-генератори структурованих даних, детальніше в розділі <a href="#3">Tools</a>.</p>
...
<p>Перевірено: ця злободенна сторінка містить Product markup <small>(як перевірити, див. <a href="#3">Tools</a>)</small>. Бачите діапазон цін в сніпеті?</p>
...
<h3>1. Title (назва), keywords (ключові слова), description (опис) <img loading="lazy" src="/images/posts/in-the-details.jpg" alt="The devil is in the details" class="fl-right restrict vw40" width="285" height="245"></h3>
	...
	<p>В дескрипшені відображаються також HTML сутності на зразок &#160;<b>&amp;phone;</b>&#160;&phone;. Проте, з думкою про мобільні браузери, йменовані сутності краще замінити цифровим кодом: <b>&amp;#9742;</b>&#160;&#9742;, таблиця відповідності <a href="https://www.freeformatter.com/html-entities.html" rel="nofollow">тут</a>.</p>
	...
	<p>В розділі Інструменти є робочий <b><a href="#simulator" class="red">симулятор Google-сніпета</a></b>: він покаже ескіз фрагмента в результатах пошуку.</p>
