...
<p>Боти щоденно сканують сайти і постачають<span class="under"> системам машинного навчання </span>величезні масиви даних для аналізу. Поглинаючи інформацію, штучний інтелект вдоско&#173;налюється, і результати його діяльності щораз більше нагаду&#173;ють висновки людини-експерта. Ключові поновлення алгоритмів <a href="https://www.google.com/intl/uk/search/howsearchworks/mission/users/">отримують оцінки</a> від найнятих Гуглом рейтерів, після чого програми коригують і знову піддають тестуванню.</p></div>
<div><h2 id="1">Вага посилань, надійність і авторитет</h2>
...
<p>В Google за облік посилань відповідає алгоритм <strong>PageRank</strong>. З 2000 року PR-число вебсторінки можна було дізнатися просто у браузері, але потім цю можливість при&#173;брали: оцінки провокували вебмайстрів на маніпуляції, що завдало значної шкоди чистоті Веб. Проте Google PageRank і досі живий: <a href="https://patents.google.com/patent/US9165040B1/en" rel="noopener" target="_blank">патент на нього</a> переоформлено у 2017, і діятиме він аж до 2027. Але нам не варто відтворювати розрахунки: PR &ndash; один з сотень складників рангу, й окремо від інших<span class="under"> він непридатний для</span> прогнозу позицій.</p>
<p>З доменом (вважаймо, сайтом) пов’язані ще такі поняття, як <strong>рівень довіри й авторитет</strong>: вони характеризують надійність і  впливо&#173;вість домену, а також глибину його зв’язків з іншими поважними ресурсами. На цих абстрак&#173;ціях ґрунтується низка авторських метрик (DA, PA, TF, TTF), однак ми їх пропу&#173;стимо: просто тому, що при обрахо&#173;вуванні рангу Гугл радше спиратиметься на власні моделі і методи.</p>
<p>
<img loading="lazy" class="fullscreen-right" src="/images/posts/link-flow-link-equity-ua.jpg" alt="Потік посилань, накопичення ваги"> Яку роль відігра&#173;ють вага (link equity, &laquo;лінковий капітал&raquo;), авторитет і т.ін.? Вони <strong>накопи&#173;чуються і розподіля&#173;ються</strong> <a href="{{site.url}}/vaga-storinky-formula-rozpodil-nofollow">за допомогою посилань</a>: що більш серйозні сайти посила&#173;ються на ресурс, тим вищий буде рівень довіри до нього пошукових систем. Зворотне правило теж діє: без припливу якісних посилань сайт матиме проблеми з довірою.
</p>
...
<p>Дебютанти можуть створювати контент під будь-які пошукові фрази, най попервах і низькочастотні. На пошуко&#173;вик вже можна покластися у тому, що мета і значення публікації будуть встановлені майже безпо&#173;милково. Якщо Гугл вважатиме, що сторінка допоможе <span class="under">запитувачу реалізувати намір, </span> вона точно посяде гідне місце.</p>
<p>Отже, уявімо, що наша сторінка з’явилася хоча б у Топ-12 результатів Google-пошуку. &nbsp;А далі…</p></div>
<div><h2 id="2">Дії та реакція користувача</h2>
<p>Далі набуває сили поведінковий фактор. Що б там в різні часи не казали гуглери, вплив &laquo;неявного відгуку&raquo; користувача на ранжування підтверджується емпірично, і частково пояснюється патентами. Думаю, поведінка юзера<span class="under"> на цільовій сторінці і в Пошуку </span>(до/після пере&#173;ходу на сайт) <strong>враховується машиною модифікації рангу</strong>.</p>
...
<p>
<img loading="lazy" class="fl-left" src="/images/posts/user-response.jpg" alt="Алгоритми Google оцінять, чи задоволений користувач сайтом">Звичайно, він не читає думок, а аналізує ланцюжок кліків і параметри часу. Щоб запобігти спотворенню даних, система алгоритмічно відсіює &laquo;найма&#173;них користу&#173;вачів&raquo;.</p>
...
<p class="txt-center"> 
<img loading="lazy" src="/images/posts/domain-authority-or-page-content-what-weighs-more.jpg" alt="Що важливіше для ранжування: авторитет + вага чи якісний контент?"> </p>
<p>Для <b>висококонкурентних комерційних</b> запи&#173;тів («купити смартфон», «seo оптимізація») співвідношення таке:</p>
<ul>
	<li><b>25%</b>&nbsp; успіху забезпечує авторитет домену;</li>
	<li><b>35%</b> – посилання сторінки та текст якорів;</li>
	<li><b>20%</b> – релевантність вмісту, мікро&#173;розмітка, SEO-теги;</li>
...
<p>Ще з обнадійливого. <span class="under">Картки продуктів </span> інтернет-магазину реально вивести в Топ без зовнішніх посилань і попри авторитет конкурентів, ЯКЩО:</p>
...
<div><h2 id="4">Чому в Топ-10 Google трапля&#173;ються сайти невисокої проби</h2>
...
<p>Безсумнівно, без сірих технік сео-просування тут не обійшлося. Але ж якби запит був знайомий пошуковій системі, досягти такого ефекту було б набагато складніше.</p>
<p>Років 5-10 тому можна було запроторити псевдотекст у підвал і тим вберегтися від сорому. Але згодом алгоритми порозум&#173;нішали й припинили ранжувати те, чого ніхто не бачить. Максимум, чого сьогодні досягне така сторінка &ndash; Топ-10 за фразовою відповід&#173;ністю ("запит у лапках").</p>
...
<p>Можна, але про маскування вмісту стане відомо, хоча б завдяки можливості <a href="https://www.google.com/webmasters/tools/spamreportform?hl=uk" rel="nofollow">поскаржитися на несовісні сайти</a>. <strong>Санкцій від Google</strong> порушнику не уникнути, адже голосування з цього приводу навряд чи призначать. Єдина рада&#8239;&ndash; санкції у відповідь!</p>
<blockquote>Update: про Пошук <span class="under">з позиції користувача.</span></blockquote> 
<p>З впровадженням алгоритму <strong>BERT</strong> 21.10.19 Google почав краще розуміти фрази. Коли Берт запрацює на повну всіма мова&#173;ми, не буде неминучої потреби упорядковувати слова за спаданням значущості: &laquo;товар колір купити недорого регіон&raquo;. До того ж система обіцяє уважніше ставитися до приймен&#173;ників, заперечних часток і т.ін.</p>
