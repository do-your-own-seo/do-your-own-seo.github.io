...
description: "Маєте якісний контент і намір просувати сайт в Пошуку? Перша необхідність – технічний аудит. Зробіть SEO аналіз сайту самостійно: це швидко(!) надійно(!!) безплатно(!!!) Необхідні інструменти та букмарклети тут"
...
---
<ul class="toc">
  <li><a href="#1">Як сайт виглядає в Google</a></li>
...
<p>На додачу до перфоманса не завадить перевірити якість коду, доступність сайту для зчитувачів екрана та SEO рівня сторінки: <a href="https://web.dev/measure/">Web.dev</a> зробить це автоматично, а ви отримаєте наочний результат.</p>
...
<ul>
  ...
  <li><em>robots.txt</em> – файл для роботів, в якому можна заборонити одному або кільком ботам індексувати сторінки, файли чи цілі директорії на сайті;</li>
  <li><em>noindex</em> – директива рівня сторінки, забороняє індексування.</li>
</ul>
<p>Тепер обираємо краулер. Якщо в інтерфейсі програми щось залишиться незрозумілим, завжди можна запитати в Ґугла. Зверніть увагу, що розрізняють хмарні (cloud-based) і десктопні веб-краулери.</p>
