...
description: "Правда ж, несправедливо, що JavaScript закладки запускаються лише на ПК? Неправда! Букмарклети працюють і на смартфоні! Треба знати лише, як виконати скрипт в контексті сторінки"
...
<div><h2 id="1">Як зберегти букмарклет в закладках мобільного браузера</h2>
  <p>На ПК це легко: достатньо перетягнути посилання на панель закладок. <span itemscope itemprop="mainEntity" itemtype="https://schema.org/Question"><meta itemprop="name" content="Як зберегти букмарклет в закладках на мобільному?"><span itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"><span itemprop="text">А тому найпростіший спосіб створити JS закладку в телефоні – це ввімкнути у своєму акаунті синхронізацію мобільного й десктопного браузерів. Якщо ж для вас це неприйнятно, лишаються два способи.</span></span></span></p>
