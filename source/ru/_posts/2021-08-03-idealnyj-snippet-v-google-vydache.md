...
title: "Как расширить сниппет страницы в Google и повысить CTR"
tags: [CTR, Rich Results, сниппет, SERP, SEO]
description: "Едва появившись в Google выдаче, страница борется за клик и свое будущее в Поиске. Органический CTR ниже, чем у конкурентов => позиции просядут. Улучшаем сниппет и повышаем CTR"
...
---
<ul class="toc">
  <li><a href="#1">Как попасть в Расширенные Результаты</a></li>
  <li><a href="#2">On-page SEO: оптимизация сниппета</a></li>
  <li><a href="#3">Инструменты для формирования сниппета&#160;&#160;<i class="icon icon-wrench red"></i></a></li>
</ul>
<div>
...
<div>
	...
	<p>
		...
		<p>Третий <a href="#3">раздел</a> будет об инструментах, которые помогут с подготовкой. А пока – пара иллюстраций.
	</p>
	...
	<p>Общие типы сущностей, вроде Organization, Person, BlogPosting, лучше описывать в JSON: для этого существуют онлайн-генераторы разметки, подробнее в разделе <a href="#3">Tools</a>.</p>
	...
	<p>Проверено: эта злободневная страница содержит Product <small>(как проверить – см. <a href="#3">Tools</a>)</small>. Видите диапазон цен в сниппете под ссылкой?</p>
...
<div>
	...
	<p>В разделе Инструменты есть рабочий <b><a href="#simulator" class="red">симулятор сниппета</a></b>: он покажет эскиз фрагмента результатов Google.</p>
