...
---
<ul class="toc">
  <li><a href="#1">Цель – расширенный фрагмент в Поиске</a></li>
  <li><a href="#2">On-page SEO: оптимизируем сниппет</a></li>
  <li><a href="#3">Инструменты для моделирования сниппета&#160;&#160;<i class="icon icon-wrench red"></i></a></li>
</ul>
<div>
