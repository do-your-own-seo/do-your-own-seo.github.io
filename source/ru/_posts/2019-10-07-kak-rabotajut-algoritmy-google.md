...
title: "Факторы ранжирования в Google 2020: что сегодня главное?"
description: "Простая магия в SEO уже бессильна: алгоритмы Google оценивают сайты не хуже людей-экспертов. Но что важнее для &#10112;&#10113;&#10114; ранжирования: ссылки или другие факторы?"
keywords: "google алгоритмы, как google ранжирует страницы"
modal: "needed"
schema: FAQPage

h1: "Как Google ранжирует сайты и на что мы можем повлиять"
...
<p><img loading="lazy" class="fl-left" src="/images/posts/user-response.jpg" alt="Алгоритмы оценят, доволен ли пользователь сайтом"> Из очевидного: по действиям вернувшегося в Поиск посетителя система оценивает, оправ&#173;дал ли сайт ожидания и полезными ли были результаты поиска в целом. «Замеряет» удов&#173;летворенность алгоритм <strong>RankBrain</strong>.</p>
<p>Конечно, он не читает мыслей, но анали&#173;зирует контекст запроса и взаимодействие юзера с резуль&#173;татами Поиска. Так же, как известные SEO-миру Панда, Пингвин (антиспам) и Голубь (локальный поиск), <a href="https://patents.google.com/patent/US9104750">RankBrain</a> представляет собой часть комп&#173;лексного поискового алгоритма &ndash; <strong>Google Humming&#173;bird</strong> (Колибри).</p>
...
<p>Текст должен быть структурирован. Заголовки должны отражать суть раздела. Контент обязан реализовать задумку автора и поразить намечен&#173;ную цель.</p>
</div>
...
<p>В итоге: текст <b>формально релевантен</b> запросу, и бедный юзер, видя знакомые слова, скроллит в надежде отыс&#173;кать крупицу смысла и закрыть проблему. Даже если не выйдет, времени на странице будет проведено немало.</p>
...
<p>Очевидно, эти ребята не пренебрегали серыми техниками продвижения. Но если бы поисковик знал запрос и разбирался в тематике, получить такой результат было бы сложнее.</p>
...
<p itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer"><span itemprop="text">С запуском <strong>алгоритма BERT</strong> 21.10.19 Google стал лучше понимать фразы. Когда изме&#173;нения вступят в силу на всех языках, не будет нужды по-особому выстраивать слова в запросе: &#171;гаджет цвет купить недорого город&#187;. К тому же система обещает серьез&#173;нее относиться к отрица&#173;ниям, предло&#173;гам и прочим коротким словечкам.</span><br> И вот, наконец: 9&nbsp;декабря 2019 обновленный BERT заговорил на русском.</p>
