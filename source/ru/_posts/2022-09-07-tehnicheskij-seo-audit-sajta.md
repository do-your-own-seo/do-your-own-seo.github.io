...
title: "Технический SEO аудит сайта с нуля. Бесплатно. Своими силами"
...
<p>Перфекционистам рекомендую более общую версию этого инструмента, <a href="https://web.dev/measure/">web.dev Measure</a>: кроме перфоманса, здесь проверят качество кода, доступность сайта для скринридеров и SEO уровня страницы. Для примера – неутешительные показатели сайта minobrnauki.gov.ru.</p>
